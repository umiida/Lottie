...
public final class WebViewBinding implements ViewBinding {
  ...
  private WebViewBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static WebViewBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
    ...
    View root = inflater.inflate(R.layout.web_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static WebViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WebViewBinding((ConstraintLayout) rootView, webView);
    }
